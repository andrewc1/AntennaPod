...
public class QueueFragment extends Fragment implements Toolbar.OnMenuItemClickListener,
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (itemId == R.id.queue_lock) {
            ...
            return true;
	} else if (itemId == R.id.queue_sort_size_asc) {
	    setSortOrder(SortOrder.SIZE_SMALL_LARGE);
	    return true;
	} else if (itemId == R.id.queue_sort_size_desc) {
	    setSortOrder(SortOrder.SIZE_LARGE_SMALL);
	    return true;
	} else if (itemId == R.id.queue_sort_density_asc) {
	    setSortOrder(SortOrder.DENSITY_LOW_HIGH);
	    return true;
	} else if (itemId == R.id.queue_sort_density_desc) {
